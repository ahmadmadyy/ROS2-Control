...
{
    CallbackReturn RRBotSystemPositionOnlyHardware::on_init(const hardware_interface::HardwareInfo & info)
    {
    ...
    CallbackReturn RRBotSystemPositionOnlyHardware::on_configure(const rclcpp_lifecycle::State &previous_state) 
    {
    ...
    CallbackReturn RRBotSystemPositionOnlyHardware::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
    {
        ...
        RCLCPP_INFO(rclcpp::get_logger("RRBotSystemPositionOnlyHardware"), "Activating ...please wait...");
