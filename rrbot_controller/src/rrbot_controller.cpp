...
namespace rrbot_controller
{
    ...
    CallbackReturn RRBotController::on_configure(const rclcpp_lifecycle::State & /*previous_state*/) {
    ...
    controller_interface::InterfaceConfiguration RRBotController::command_interface_configuration() const{
    ...
    controller_interface::return_type RRBotController::update(const rclcpp::Time &time,
